              ...
              <div class="relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                  <div class="text-center">
                    <div class="text-2xl font-bold {getProgressColor($progressValue)}">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-sm text-gray-500"
                      >{milestone.current_value}/{milestone.target_value} {milestone.unit}</span
                    >
                  </div>
                  <div class="w-full bg-gray-200 rounded-full h-2">
                    <div
                      class="h-2 rounded-full transition-all duration-500 {getProgressStrokeColor(
                  ...
                  {#each dashboardData.suggestedBuddies as buddy}
                    <div class="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                      <div class="flex items-center">
                        <div
                          class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white text-sm font-bold mr-3"
                        >
                          {buddy.first_name?.[0] || '?'}
                        </div>
                        <div>
                  ...
                  {#each dashboardData.recentReferrals as referral}
                    <div class="bg-white border border-gray-200 rounded-lg p-4">
                      <div class="flex items-center justify-between mb-2">
                        ...
                        <span
                          class="text-xs px-2 py-1 rounded {referral.status === 'completed'
