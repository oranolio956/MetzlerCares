...
<style>
  ...
  .premium-card--glow::before {
    ...
    right: -2px;
    bottom: -2px;
    background: linear-gradient(45deg, var(--color-sunset-orange, #FF6B35), var(--color-mountain-blue, #4A90E2), var(--color-forest-green, #2D5016));
    border-radius: var(--radius-xl, 0.75rem);
    opacity: 0;
    z-index: -1;
  ...
  .premium-card__glow {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(135deg, var(--color-sunset-orange, #FF6B35) 0%, var(--color-mountain-blue, #4A90E2) 100%);
    opacity: 0;
    border-radius: var(--radius-xl, 0.75rem);
    transition: opacity 0.3s ease;
    pointer-events: none;
