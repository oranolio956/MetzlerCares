...
{#if isOpen}
  ...
  >
    ...
    >
      <!-- Chat Header -->
      <div
        class="flex items-center justify-between p-4 border-b border-forest-green/10 bg-gradient-to-r from-forest-green/5 to-mountain-blue/5"
      >
        <div class="flex items-center space-x-3">
          <div
            class="w-10 h-10 rounded-full bg-gradient-to-br from-forest-green to-mountain-blue flex items-center justify-center"
          >
      ...
      >
          ...
          >
            <div
              class="max-w-[80%] {message.sender === 'user'
                ...
                : 'bg-forest-green/5 text-forest-green border border-forest-green/10'} rounded-2xl px-4 py-3 shadow-sm"
            >
        ...
        {#if isTyping}
          <div class="flex justify-start">
            <div
              class="bg-forest-green/5 text-forest-green border border-forest-green/10 rounded-2xl px-4 py-3 shadow-sm"
            >
              <div class="flex space-x-2">
                <div class="w-2 h-2 bg-forest-green/40 rounded-full animate-bounce" style="animation-delay: 0ms" />
                <div class="w-2 h-2 bg-forest-green/40 rounded-full animate-bounce" style="animation-delay: 150ms" />
                <div class="w-2 h-2 bg-forest-green/40 rounded-full animate-bounce" style="animation-delay: 300ms" />
              </div>
            </div>
          </div>
        {/if}
      ...
      <div class="p-4 border-t border-forest-green/10 bg-white/50">
        ...
        <p class="text-xs text-mountain-blue/70 mt-2 text-center">Press Enter to send • Shift+Enter for new line</p>
      </div>
    </PremiumCard>
  </div>
{/if}
