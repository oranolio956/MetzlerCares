  ...
  <div class="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    <div class="space-y-6">
      ...
      <h2 class="text-3xl md:text-4xl font-bold text-white">
        Every partner gets a telemetry report, not a testimonial.
      </h2>
      <p class="text-lg text-brand-muted">
        We quantify field operations in the same units as CFOs, quality teams, and Medicaid reviewers. That means faster
        approvals, faster reimbursements, and fewer “trust us” decks.
      </p>
      <div class="space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
      {#each stats as stat}
        <div class="p-6 rounded-3xl border border-brand-border bg-gradient-to-br from-white/[0.04] to-brand-card/30">
