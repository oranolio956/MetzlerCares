  ...
  <div class="container mx-auto px-4 grid grid-cols-1 xl:grid-cols-5 gap-12 items-start">
      ...
      <div class="space-y-6">
        {#each loops as loop, index}
            <div class="p-5 rounded-2xl border border-brand-border bg-white/[0.03] backdrop-blur" in:fly={{ x: -16, duration: 450, delay: 80 * index }}>
    ...
    <div class="xl:col-span-3">
      ...
      >
        ...
        <div class="relative space-y-6">
            ...
            <div
                class="group relative p-6 rounded-3xl bg-brand-card/70 border border-brand-border backdrop-blur flex flex-col gap-4 md:flex-row md:items-center transition-transform duration-300 hover:-translate-y-1"
