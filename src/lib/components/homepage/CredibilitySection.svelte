    ...
    <div class="lg:col-span-2 space-y-6">
      ...
      <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-6">
        {#each items as item, index}
          <button
            type="button"
            class="text-left p-6 rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-card)]/50 hover:bg-[var(--surface-card)]/80 backdrop-blur-md focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface-night)] transition duration-500 opacity-0 translate-y-6 data-[reveal=visible]:opacity-100 data-[reveal=visible]:translate-y-0 shadow-lg hover:shadow-xl"
