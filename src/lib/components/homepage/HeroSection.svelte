  ...
  />
    ...
    <div class="xl:col-span-5 space-y-8">
      ...
      <div class="xl:col-span-5 space-y-8">
        <HeroMedia />
        <div
          class="relative rounded-[32px] border border-brand-border bg-brand-card/80 backdrop-blur-2xl p-8 shadow-[0_25px_80px_rgba(5,6,10,0.75)]"
        >
          ...
          <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              <div class="rounded-2xl bg-brand-card/70 border border-brand-border p-4 flex items-center justify-between gap-4">
                <div>
              ...
              <div class="rounded-2xl border border-brand-border p-4 bg-gradient-to-br from-brand-teal/15 to-brand-iris/15">
