...
<section class="relative min-h-screen flex items-center pt-28 pb-20" aria-labelledby="hero-title">
    ...
    <div class="xl:col-span-5 space-y-8">
      <div
        class="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-[var(--surface-border)] bg-[var(--surface-glass)] text-[11px] uppercase tracking-[0.28em] text-[var(--text-muted)]/90"
      >
        {tag}
      </div>
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        <a
          href="/contact"
          class="btn-primary text-lg px-9 py-4 rounded-full"
        ...
        <a
          ...
          class="btn-outline text-lg px-9 py-4 rounded-full border-[var(--surface-border)] text-[var(--text-secondary)] hover:bg-[var(--surface-glass)] hover:text-white"
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8">
        {#each signals as signal, index}
          <div class="p-5 rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-card)]/60 backdrop-blur-md" in:fly={{ y: 14, duration: 400, delay: index * 80 }}>
      ...
      <div class="xl:col-span-5 space-y-8">
        <HeroMedia />
        <div
          class="relative rounded-[32px] border border-[var(--surface-border)] bg-[var(--surface-card)]/80 backdrop-blur-2xl p-8 shadow-2xl"
        >
          ...
          <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              ...
              <div class="rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-card)]/70 p-4">
            ...
            <div class="space-y-4">
              <div class="rounded-2xl bg-[var(--surface-card)]/70 border border-[var(--surface-border)] p-4 flex items-center justify-between gap-4">
                <div>
              ...
              <div class="rounded-2xl bg-[var(--surface-card)]/70 border border-[var(--surface-border)] p-4">
              ...
              <div class="rounded-2xl border border-[var(--surface-border)] p-4 bg-gradient-to-br from-[var(--color-accent)]/15 to-[var(--color-accent-lilac)]/15">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            <div class="rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-card)]/70 p-5 flex items-center justify-between">
              <div>
            ...
            <div class="rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-card)]/70 p-5">
