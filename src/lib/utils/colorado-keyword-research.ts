  ...
  detox: [
    {
      ...
      competitorGap: [
        'ripoff report detox colorado',
        'detox center complaints colorado',
        'legitimate detox facilities colorado',
        'verified detox centers denver'
      ],
      searchVolume: 2400,
      difficulty: 45,
      cpc: 12.5,
    ...
    },
    {
      ...
      competitorGap: [
        'alcohol detox success rates colorado',
        'alcohol detox reviews denver',
        'affordable alcohol detox colorado springs',
        'medicaid alcohol detox'
      ],
      searchVolume: 1600,
      difficulty: 38,
      cpc: 15.75,
  ...
  rehab: [
    {
      ...
      competitorGap: [
        'ripoff report drug rehab colorado',
        'legitimate drug treatment centers',
        'verified drug rehab facilities',
        'drug rehab scam avoidance colorado'
      ],
      searchVolume: 3200,
      difficulty: 52,
      cpc: 18.9,
    ...
    },
    {
      ...
      competitorGap: [
        'inpatient rehab waiting lists colorado',
        'inpatient rehab success rates',
        'affordable inpatient treatment colorado',
  ...
  'sober-living': [
    {
      ...
      competitorGap: [
        ...
        'free sober living colorado',
        'verified sober living homes',
        'legitimate recovery residences'
      ],
      searchVolume: 1100,
      difficulty: 35,
      cpc: 8.75,
  ...
  'competitor-gap': [
    {
      ...
      competitorGap: [
        'avoid rehab scams colorado',
        'legitimate rehab centers',
        'rehab center complaints',
        'verified treatment facilities'
      ],
      searchVolume: 880,
      difficulty: 28,
      cpc: 6.25,
    ...
    },
    {
      ...
      competitorGap: [
        'hidden rehab costs colorado',
        'rehab pricing transparency',
        'no hidden fees treatment',
        'affordable quality rehab'
      ],
      searchVolume: 1300,
      difficulty: 31,
      cpc: 9.4,
...
export const COLORADO_COMPETITORS: CompetitorAnalysis[] = [
  {
    ...
    topKeywords: [
      'rehab scams',
      'treatment center complaints',
      'addiction treatment fraud',
      'rehab ripoffs',
      'treatment center reviews'
    ],
    contentGaps: [
      'legitimate rehab alternatives',
    ...
    rankingFactors: ['domain authority', 'user engagement', 'fresh content', 'brand mentions'],
    weaknesses: [
  ...
  },
  {
    ...
    topKeywords: [
      ...
      'sobriety journey',
      'recovery advice',
      'addiction treatment experiences',
      'rehab success stories'
    ],
    contentGaps: [
...
export function generateCityKeywordStrategy(city: string, county: string): LocalSEOKeywords {
  const baseKeywords = Object.entries(COLORADO_REHAB_KEYWORD_CLUSTERS).flatMap(([category, clusters]) =>
    clusters.map(cluster => ({
      ...
      longTail: cluster.longTail.map(k =>
        k.replace('colorado', city.toLowerCase()).replace('denver', city.toLowerCase())
      ),
...
export function generateContentBrief(
  ...
  const relevantClusters = strategy.primaryClusters.filter(
    cluster => cluster.primary.includes(topic) || cluster.secondary.some(s => s.includes(topic))
  )
