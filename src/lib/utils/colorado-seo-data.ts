...
export const COLORADO_RECOVERY_SERVICES: RecoveryService[] = [
  {
    ...
    type: 'sober_living',
    description:
      'Award‑winning recovery housing programs with multiple locations across Denver Metro, Colorado Springs, Longmont, and Pueblo. Scholarships available.',
...
export const SEO_TEMPLATES: Record<string, SEOContentTemplate> = {
  city_sober_living: {
    ...
    metaDescription:
      'Find top‑rated sober living homes and recovery housing in {city}, Colorado. Scholarships available. Comprehensive guide to safe, supportive recovery environments.',
    h1: 'Sober Living & Recovery Housing in {city}, Colorado',
    contentStructure: {
      introduction:
        '{city}, Colorado offers numerous sober living and recovery housing options for individuals seeking supportive environments during their recovery journey.',
      sections: [
        {
          heading: 'Top Sober Living Homes in {city}',
          content:
            'Discover the highest‑rated sober living facilities in {city}, Colorado, including services, amenities, and scholarship opportunities.',
          keywords: ['sober living {city}', 'recovery housing {city}', 'halfway house {city}']
        },
        {
          heading: 'Scholarships & Financial Assistance',
          content:
            'Learn about available scholarships, grants, and financial assistance programs for sober living in {city}, Colorado.',
        ...
        },
        {
          ...
          content:
            'Understand the structure, rules, and support systems available in {city} sober living environments.',
      ...
      faqs: [
        {
          ...
          answer:
            'Sober living costs in {city} typically range from $600‑$1,550 per month, with scholarships and sliding‑scale options available.'
        },
        {
          question: 'Are scholarships available for sober living in {city}?',
          answer:
            'Yes, several organizations offer sober living scholarships in {city}, including the Hornbuckle Foundation and Hazelbrook Recovery Residences.'
        },
        {
          question: 'What services are included in {city} recovery housing?',
          answer:
            'Most sober living homes in {city} include peer support, group therapy, life‑skills training, and recovery coaching.'
        }
      ]
    },
    schema: {
...
// ---- Treatment Data -------------------------------------------------------
export const TREATMENT_DATA: Record<
  string,
  {
    icon: string
    name: string
