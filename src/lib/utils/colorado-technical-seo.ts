    ...
    const faqs = data.faqs || [
      {
        ...
        answer: 'Sober living costs in Colorado typically range from $600-$1,550 per month, with scholarships available.'
      },
      {
        question: 'Are scholarships available for recovery housing?',
        answer: 'Yes, several organizations offer recovery housing scholarships in Colorado, including the Hornbuckle Foundation.'
      },
      {
