...
<svelte:head>
  ...
  <meta
    name="description"
    content="Comprehensive SEO analytics dashboard for Colorado recovery services performance tracking and optimization"
  />
</svelte:head>
      ...
      <div class="bg-red-50 border border-red-200 rounded-md p-4">
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <div class="mt-4">
              <button on:click={refreshData} class="text-sm font-medium text-red-600 hover:text-red-500">
                Try again
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-sm text-gray-600">
                {analyticsData.summary.top10Rankings}/{analyticsData.summary.totalKeywords} keywords
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-sm {getTrendColor(analyticsData.summary.trafficGrowth)}">
                {formatPercentage(analyticsData.summary.trafficGrowth)}
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
              <div class="flex justify-between items-center">
                ...
                <span class="text-lg font-bold text-green-600"
                  >{analyticsData.technicalMetrics.coreWebVitals.score.toFixed(0)}/100</span
                >
              </div>
            </div>
          </div>
