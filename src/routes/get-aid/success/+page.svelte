...
<svelte:head>
  ...
  <meta name="description" content="Your scholarship application has been submitted successfully. We'll be in touch soon." />
</svelte:head>
  ...
  <main class="py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto text-center">
        ...
        <div class="space-y-6">
          <div class="flex items-start">
            ...
            <div class="ml-3 text-left">
              ...
              <p class="text-sm text-navy text-opacity-70 mt-1">
                Your income eligibility has been verified using secure, encrypted automated services.
                No paperwork or pay stubs were required.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-left">
              ...
              <p class="text-sm text-navy text-opacity-70 mt-1">
                Your explicit consent for Treatment, Payment, and Operations has been securely recorded
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-left">
              ...
              <p class="text-sm text-navy text-opacity-70 mt-1">
                Our team will now match you with approved sober living partners in Colorado.
                You'll receive an email within 1-2 business days with placement options.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="bg-navy bg-opacity-5 rounded-lg p-6 mb-8">
        ...
        <div class="text-left space-y-3 text-sm text-navy text-opacity-80">
          <div class="flex items-start space-x-3">
            <span class="flex-shrink-0 w-6 h-6 bg-navy text-cream rounded-full flex items-center justify-center text-xs font-medium">1</span>
            <p>Our case managers review your application and identify suitable sober living homes</p>
          </div>
          <div class="flex items-start space-x-3">
            <span class="flex-shrink-0 w-6 h-6 bg-navy text-cream rounded-full flex items-center justify-center text-xs font-medium">2</span>
            <p>You'll receive placement options via email with facility details and availability</p>
          </div>
          <div class="flex items-start space-x-3">
            <span class="flex-shrink-0 w-6 h-6 bg-navy text-cream rounded-full flex items-center justify-center text-xs font-medium">3</span>
            <p>Once you select a facility, we process your scholarship payment directly to them</p>
          </div>
          <div class="flex items-start space-x-3">
            <span class="flex-shrink-0 w-6 h-6 bg-navy text-cream rounded-full flex items-center justify-center text-xs font-medium">4</span>
      ...
      <div class="text-center">
        ...
        <button
          on:click={() => goto('/get-aid/status')}
          class="text-olive hover:text-navy font-medium text-sm"
        >
      ...
      <div class="mt-12 text-center text-xs text-navy text-opacity-60">
        <p>Questions? Contact our support team at <a href="mailto:support@metzlerfoundations.org" class="text-olive hover:text-navy">support@metzlerfoundations.org</a></p>
