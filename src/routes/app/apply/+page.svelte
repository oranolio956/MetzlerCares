...
<svelte:head>
  ...
  <meta name="description" content="Begin your journey to recovery housing and support services with Metzler Foundations." />
</svelte:head>
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-blue-700">
                  <p class="mb-2">This application involves Protected Health Information (PHI) and Substance Use Disorder (SUD) records.</p>
                  <p>Your consent is required under 42 CFR Part 2 (Confidentiality of Substance Use Disorder Records) and the Colorado Privacy Act.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 border border-gray-200 rounded-md p-4">
            ...
            <div class="text-sm text-gray-700 space-y-3 mb-4">
              ...
              <p class="font-medium text-gray-900 mt-3">
                By checking the box below, I acknowledge that I have read and understand this consent agreement
                and voluntarily authorize the use and disclosure of my protected health information as described above.
              </p>
            </div>
