...
export const GET: RequestHandler = async ({ url }) => {
  try {
    ...
    const existingPages = [
      ...
      { url: `${url.origin}/platform`, lastModified: new Date().toISOString(), priority: 0.9 },
      { url: `${url.origin}/investors`, lastModified: new Date().toISOString(), priority: 0.8 },
      { url: `${url.origin}/careers`, lastModified: new Date().toISOString(), priority: 0.8 },
    ...
    guides.push({
      url: `${url.origin}/guides/scholarship-pathways`,
      lastModified: new Date().toISOString(),
      priority: 0.7
    })
