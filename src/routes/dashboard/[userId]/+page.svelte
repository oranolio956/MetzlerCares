...
<svelte:head>
  ...
  <meta
    name="description"
    content="Track your recovery progress, achievements, and connect with your support community."
  />
</svelte:head>
  ...
  {#if isLoading}
    <div class="flex items-center justify-center min-h-screen">
      <div class="text-center">
        <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-mountain-blue mx-auto mb-4" />
  ...
  {:else if error}
    <div class="flex items-center justify-center min-h-screen">
      <div class="text-center bg-white p-10 rounded-xl shadow-premium border border-warm-gray">
        ...
        <a
          href="/"
          class="bg-mountain-blue text-white px-8 py-3 rounded-lg hover:bg-mountain-blue/90 transition-colors font-bold shadow-mountain"
        >
          Go Home
        </a>
      </div>
          ...
          <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center space-x-6">
              <span class="text-charcoal font-medium"
                >Welcome back, <span class="text-mountain-blue">{userData.first_name || 'Friend'}</span>!</span
              >
              <a href="/" class="text-charcoal/60 hover:text-mountain-blue transition-colors text-sm font-medium"
                >Home</a
              >
            </div>
          </div>
