    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
      ...
      <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-8">
        ...
        <div class="prose max-w-none text-gray-700 space-y-4">
          <p>
            ...
            <strong>treatment, payment, and healthcare operations (TPO)</strong> as permitted under 42 CFR Part 2 - the federal
            confidentiality regulations for substance use disorder treatment.
          </p>
          <p>I understand that:</p>
          <ul class="list-disc pl-6 space-y-2">
            <li>My treatment information is protected by federal law</li>
            <li>
              I may revoke this consent at any time, except to the extent that action has been taken in reliance on it
            </li>
      ...
      <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-8">
        ...
        <div class="space-y-6">
          ...
          <div>
            <label for="signature-canvas" class="block text-sm font-medium text-gray-700 mb-2"
