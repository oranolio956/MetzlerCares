<section class="min-h-screen bg-cream text-charcoal py-16 px-4 sm:px-6 lg:px-8">
  <div class="max-w-4xl mx-auto">
    ...
    <div class="prose prose-lg text-charcoal text-opacity-80">
      ...
      <h2 class="text-2xl font-medium text-charcoal mt-8 mb-4">1. Introduction</h2>
      <p>
        Metzler Foundations ("we," "our," or "us") respects your privacy and is committed to protecting your personal
        data. This privacy policy will inform you as to how we look after your personal data when you visit our website
        (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.
      </p>

      <h2 class="text-2xl font-medium text-charcoal mt-8 mb-4">2. Data We Collect</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-charcoal mt-8 mb-4">3. How We Use Your Data</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-charcoal mt-8 mb-4">4. Data Security</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-charcoal mt-8 mb-4">5. Your Legal Rights</h2>
      <p>
      ...
      <p class="mt-4">
        ...
        Email: privacy@metzlerfoundations.org<br />
        Phone: (555) 123-4567
      </p>
    </div>
  </div>
