...
<svelte:head>
  ...
  <meta
    name="description"
    content="Age verification and parental consent system for minors accessing addiction recovery housing services. COPPA compliant."
  />
</svelte:head>
            ...
            <div class="flex">
              ...
              <div>
                ...
                <p class="text-blue-700 text-sm mt-1">
                  Since you are under 18, we need consent from your parent or legal guardian to continue. This is
                  required by law to protect your privacy and ensure appropriate services.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-4 rounded-md">
            <div class="flex items-start">
              ...
              <label for="consentGiven" class="ml-3 text-sm text-gray-700">
                <strong
                  >I confirm that my parent/legal guardian has given consent for me to use this website and its
                  services.</strong
                >
        ...
        <div class="space-y-6 text-center">
          ...
          <div>
            ...
            <p class="text-gray-600">
              We've sent a verification request to <strong>{parentalConsentForm.parentEmail}</strong>. Your parent/legal
              guardian needs to confirm their consent before you can continue.
            </p>
          </div>
      ...
      {:else if verificationStep === 'approved'}
        <div class="space-y-6 text-center">
          ...
          <div class="bg-green-50 border border-green-200 rounded-md p-4">
            <p class="text-sm text-green-800">Redirecting you to the homepage in a moment...</p>
          </div>
        </div>
      {/if}
    </div>
