...
<div class="min-h-screen bg-cream text-navy">
  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="text-center mb-8">
      <h1 class="text-3xl font-serif font-medium text-navy mb-4">Complete Your Donation</h1>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-navy border-opacity-10 p-6 mb-8 max-w-md mx-auto">
        <div class="flex items-center justify-between">
          <div class="text-left">
            <h3 class="font-medium text-navy mb-1">Anonymous Donation</h3>
            <p class="text-sm text-navy text-opacity-60">Give without providing personal information</p>
          </div>
          <button
            type="button"
            on:click={() => {
            ...
            class={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-olive focus:ring-offset-2 ${
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="bg-white rounded-lg border border-navy border-opacity-10 p-6 text-center">
        ...
        <h3 class="font-medium text-navy mb-2">Secure & Encrypted</h3>
        <p class="text-sm text-navy text-opacity-70">Bank-level SSL encryption protects your information</p>
      </div>
      ...
      <div class="bg-white rounded-lg border border-navy border-opacity-10 p-6 text-center">
        ...
        <h3 class="font-medium text-navy mb-2">Tax Deductible</h3>
        <p class="text-sm text-navy text-opacity-70">Receive a tax receipt for your donation</p>
      </div>
      ...
      <div class="bg-white rounded-lg border border-navy border-opacity-10 p-6 text-center">
        ...
        <h3 class="font-medium text-navy mb-2">Immediate Impact</h3>
        <p class="text-sm text-navy text-opacity-70">Funds are distributed within 24-48 hours</p>
      </div>
    </div>
    ...
    <div class="mt-12 text-center">
      <p class="text-sm text-navy text-opacity-60">
        ...
        <a href="mailto:support@metzlerfoundations.org" class="text-olive hover:text-navy ml-1">
          Contact our support team
        </a>
      </p>
      <p class="text-sm text-navy text-opacity-60 mt-2">
