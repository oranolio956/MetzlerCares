  ...
  <div class="min-h-screen bg-cream text-navy">
    ...
    <section class="px-4 py-12 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-4xl rounded-3xl border border-[var(--color-border)] bg-white/80 p-10 text-center shadow-sm">
        <p class="text-sm font-semibold uppercase tracking-[0.3em] text-charcoal/50">Detox directory</p>
        <h1 class="mt-4 text-4xl font-serif font-medium text-navy md:text-5xl">
          Colorado Detox Centers & Medical Detoxification
        </h1>
        <p class="mt-4 text-lg text-charcoal/80">
          Medically supervised detox partners that offer round-the-clock monitoring for alcohol and drug withdrawal across Colorado.
        </p>
