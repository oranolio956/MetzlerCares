...
<div class="hero-section">
  ...
  <div class="relative z-10 text-center px-6 max-w-6xl mx-auto">
    ...
    <div class="mb-16 animate-fade-in" style="animation-delay: 0.2s;">
      <h1 class="text-6xl font-serif font-medium text-deep-navy-900 mb-6 tracking-tight leading-tight">
        The Bridge to Recovery
      </h1>
      <p class="text-xl text-deep-navy-700 max-w-2xl mx-auto leading-relaxed">
    ...
    <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
      {#each navigationCards as card, index}
        <div 
          class="card cursor-pointer group transform transition-all duration-500 hover:scale-105 animate-fade-in"
        ...
        >
          <div class="text-center">
            ...
            <!-- Title -->
            <h2 class="text-2xl font-semibold text-deep-navy-900 mb-3 tracking-wide">
              {card.title}
            </h2>
            
            <!-- Description -->
            <p class="text-deep-navy-700 font-medium">
              {card.description}
            </p>
            
            <!-- Hover indicator -->
            <div class="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div class="w-8 h-1 bg-deep-navy-600 rounded-full mx-auto"></div>
            </div>
          </div>
        </div>
      {/each}
    ...
    <div class="mt-24 animate-fade-in" style="animation-delay: 0.6s;">
      <div class="text-center mb-6">
        <h2 class="text-2xl font-serif font-medium text-deep-navy-900 mb-3">Scholarships & FAQ</h2>
        <p class="text-deep-navy-700">Explore sober living scholarships and answers to common questions</p>
      </div>
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="/scholarships" class="btn-primary">Sober Living Scholarships</a>
        <a href="/faq/sober-living" class="btn-secondary-outline">Sober Living FAQ</a>
      </div>
