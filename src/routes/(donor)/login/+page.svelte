...
<div class="min-h-screen bg-cream text-navy flex items-center justify-center px-4">
  <div class="max-w-md w-full">
    ...
    <div class="text-center mb-8">
      <h1 class="text-3xl font-serif font-medium text-navy mb-2">
        Donor Portal
      </h1>
      <p class="text-navy text-opacity-70">
        Access your personalized impact dashboard
      </p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-navy border-opacity-10 p-8">
      ...
      {#if message}
        <div class="mt-4 p-4 rounded-md {isSuccess ? 'bg-green-50 border border-green-200 text-green-700' : 'bg-red-50 border border-red-200 text-red-700'}">
          {message}
        </div>
      {/if}
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-navy text-opacity-60">
          ...
          <a href="/give-support" class="text-navy underline hover:text-olive">
    ...
    <div class="text-center mt-8">
      <a href="/" class="text-navy text-opacity-60 hover:text-navy underline">
        ← Back to Home
      </a>
    </div>
  </div>
