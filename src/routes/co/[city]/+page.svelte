    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="text-center">
        ...
        <p class="text-xl text-blue-100 max-w-3xl mx-auto">
          Comprehensive recovery resources and sober living options in {location.city}, Colorado. Find scholarships,
          treatment centers, and support services to help you or your loved one on the path to recovery.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
              ...
              {#each data.nearbyServices as svc}
                <div class="border border-gray-200 rounded-md p-4">
                  ...
                  <div class="text-sm text-gray-600 mb-1">
                    ...
                    {svc.paymentOptions.join(', ')}
                  </div>
                  <div class="text-sm text-gray-600 mb-1">
                    <strong>Certifications:</strong>
                    {svc.certifications.join(', ')}
                  </div>
                  {#if svc.website}
                    <a href={svc.website} class="text-blue-600 hover:text-blue-800 hover:underline text-sm"
                      >Visit Website</a
                    >
                  {/if}
                </div>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <div class="space-y-2">
          <a href="/scholarships" class="block text-blue-600 hover:text-blue-800 hover:underline"
            >Sober Living Scholarships</a
          >
          <a href="/faq/sober-living" class="block text-blue-600 hover:text-blue-800 hover:underline"
            >Sober Living FAQ</a
          >
        </div>
      </div>
  ...
  <div class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
      ...
      <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
        Metzler Cares provides scholarships and support for sober living and recovery services throughout Colorado. Let
        us help you find the right path forward.
      </p>
