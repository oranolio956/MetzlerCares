...
<div class="min-h-screen bg-cream">
  ...
  <section class="hero-premium min-h-[60vh]">
    <div class="hero-premium__content">
      ...
      <p class="hero-premium__subtitle">
        ...
        {treatmentInfo.successRate} success rate. Average wait time: {cityStats.averageWaitTime}.
      </p>
      ...
      <div
        class="bg-white/10 backdrop-blur-premium rounded-xl p-8 max-w-2xl mx-auto border border-white/20 shadow-premium"
      >
  ...
  <section class="py-12 bg-white border-b border-warm-gray">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-70 grayscale hover:grayscale-0 transition-all duration-500"
      >
      ...
      <div class="grid md:grid-cols-2 gap-16 items-start">
        <div>
          ...
          <p class="text-lg text-charcoal mb-6 leading-relaxed">
            {treatmentInfo.description} in {location.city}, Colorado. With a population of {location.population?.toLocaleString() ||
              'N/A'},
        ...
        <div>
          ...
          <div class="space-y-4 mb-12">
            {#each treatmentInfo.services as service}
              <div
                class="flex items-center p-4 bg-gray-50 rounded-lg border border-warm-gray hover:border-mountain-blue transition-colors duration-200"
              >
          ...
          <h3 class="text-2xl font-bold text-forest-green mb-6">Treatment Levels Available</h3>
          <div class="flex flex-wrap gap-3">
            {#each treatmentInfo.levels as level}
              <span
                class="px-4 py-2 bg-mountain-blue/10 text-mountain-blue font-medium rounded-full text-sm border border-mountain-blue/20"
              >
                {level}
              </span>
            {/each}
  ...
  <section class="py-20 bg-white border-y border-warm-gray/20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="text-3xl md:text-4xl font-bold text-forest-green mb-12 text-center">Local Recovery Resources</h2>
      <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-white p-6 rounded-xl border border-warm-gray shadow-sm hover:shadow-md transition-shadow">
          ...
          <p class="text-charcoal/80 text-sm mb-4">
            Safe, supervised withdrawal management facilities in {location.city}.
          </p>
          <a
            href="/co/{location.city.toLowerCase().replace(/\s+/g, '-')}/detox"
            class="text-mountain-blue font-medium text-sm hover:underline">Find Detox Centers &rarr;</a
          >
        </div>
        <div class="bg-white p-6 rounded-xl border border-warm-gray shadow-sm hover:shadow-md transition-shadow">
          ...
          <p class="text-charcoal/80 text-sm mb-4">
            Structured recovery housing and transitional living in {location.city}.
          </p>
          <a
            href="/co/{location.city.toLowerCase().replace(/\s+/g, '-')}/sober-living"
            class="text-mountain-blue font-medium text-sm hover:underline">View Housing Options &rarr;</a
          >
        </div>
        <div class="bg-white p-6 rounded-xl border border-warm-gray shadow-sm hover:shadow-md transition-shadow">
          ...
          <a href="/resources/colorado" class="text-mountain-blue font-medium text-sm hover:underline"
            >Find Meetings &rarr;</a
          >
        </div>
      </div>
    </div>
  ...
  <section class="py-20 bg-white">
    <div
      class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-headings:font-primary prose-headings:text-forest-green prose-p:text-charcoal prose-a:text-mountain-blue"
    >
  ...
  <section class="py-20 bg-cream">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="text-3xl md:text-4xl font-bold text-forest-green mb-12 text-center">Frequently Asked Questions</h2>
      <div class="space-y-6">
        ...
        {#each insuranceProviders as provider}
          <a href="/insurance/{provider.toLowerCase().replace(' ', '-')}" class="block group">
            <div class="card-premium p-8 text-center h-full group-hover:border-mountain-blue">
              <h3 class="text-xl font-bold text-forest-green mb-3 group-hover:text-mountain-blue transition-colors">
                {provider}
              </h3>
              ...
              <div
                class="text-mountain-blue font-medium group-hover:translate-x-1 transition-transform inline-flex items-center"
              >
  ...
  <section class="py-24 bg-forest-green text-white relative overflow-hidden">
    <div class="absolute inset-0 bg-mountain-blue/20 mix-blend-overlay" />
