<script lang="ts">
  ...
  const overviewContent = data?.overviewContent || {
    ...
    description:
      'Comprehensive directory of recovery services, sober living homes, and addiction treatment centers throughout Colorado.',
...
<svelte:head>
  ...
  <meta
    name="keywords"
    content="Colorado recovery services, sober living Colorado, addiction treatment Colorado, recovery housing, Colorado drug rehab, Colorado alcohol treatment"
  />
            ...
            {#each highPriorityCities as city}
              ...
              >
                ...
                <p class="text-sm text-gray-600 mt-1">
                  {city.county} County • Population: {city.population.toLocaleString()}
                </p>
              </a>
            {/each}
          </div>
    ...
    <section class="bg-white rounded-lg shadow-sm p-8 mt-8">
      <div class="text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
          <a
            href="/faq/sober-living"
            class="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-md hover:bg-blue-50 transition-colors"
            >Sober Living FAQ</a
          >
        </div>
      </div>
