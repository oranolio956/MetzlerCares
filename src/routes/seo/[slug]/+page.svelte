<script lang="ts">
  ...
  function generateAdvancedSchema(data: any) {
    ...
    const faqSchema = {
      ...
      mainEntity: data.h2s?.slice(0, 5).map((h2: string, index: number) => ({
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Learn about ${h2.toLowerCase()} in ${data.city}. Our comprehensive ${
            data.service
          } services provide evidence-based treatment with proven results.`
        }
      }))
    }
  ...
  function generateContentSections(data: any) {
    ...
    return (
      data.h2s?.map((h2: string, index: number) => ({
        title: h2,
  ...
  function generateSectionContent(h2: string, city: string, service: string, index: number) {
    ...
    return (
      sectionTemplates[h2 as keyof typeof sectionTemplates] ||
  ...
  {:else if seoData}
    ...
    <section class="relative py-20 px-4">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            class="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors font-semibold"
          >
    ...
    <section class="py-16 px-4 bg-white">
      <div class="max-w-6xl mx-auto">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">Why Choose Metzler Cares</h2>
    ...
    <section class="py-16 px-4 bg-blue-600">
      <div class="max-w-4xl mx-auto text-center">
        <h2 class="text-3xl font-bold text-white mb-6">Ready to Start Your Recovery Journey?</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            class="border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors font-semibold"
          >
            Schedule Assessment
          </button>
        </div>
