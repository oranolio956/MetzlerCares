<section class="min-h-screen bg-cream text-navy py-16 px-4 sm:px-6 lg:px-8">
  <div class="max-w-4xl mx-auto">
    ...
    <div class="prose prose-lg text-navy text-opacity-80">
      <p class="mb-6">Last Updated: {new Date().toLocaleDateString()}</p>

      <h2 class="text-2xl font-medium text-navy mt-8 mb-4">1. What Are Cookies</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-navy mt-8 mb-4">2. How We Use Cookies</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-navy mt-8 mb-4">3. Disabling Cookies</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-navy mt-8 mb-4">4. The Cookies We Set</h2>
      <ul class="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Account related cookies:</strong> If you create an account with us then we will use cookies for the management
          of the signup process and general administration. These cookies will usually be deleted when you log out however
          in some cases they may remain afterwards to remember your site preferences when logged out.
        </li>
        <li>
          <strong>Login related cookies:</strong> We use cookies when you are logged in so that we can remember this fact.
          This prevents you from having to log in every single time you visit a new page. These cookies are typically removed
          or cleared when you log out to ensure that you can only access restricted features and areas when logged in.
        </li>
        <li>
          <strong>Forms related cookies:</strong> When you submit data to through a form such as those found on contact pages
          or comment forms cookies may be set to remember your user details for future correspondence.
        </li>
      </ul>

      <h2 class="text-2xl font-medium text-navy mt-8 mb-4">5. Third Party Cookies</h2>
      <p>
      ...
      <h2 class="text-2xl font-medium text-navy mt-8 mb-4">6. More Information</h2>
      <p>
