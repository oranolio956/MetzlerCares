...
export const schemaTypes: SchemaTypeDefinition[] = [
...

  {
    ...
    fields: [
      ...
      { name: 'is_featured', title: 'Featured', type: 'boolean', initialValue: true },
  ...
  // Legal framework for preferred provider network relationships
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        rows: 3,
        initialValue: 'This Memorandum of Understanding (MOU) is made between Metzler Foundations, Inc. ("The Foundation") and [Partner Facility Name] ("The Provider").',
        readOnly: true,
      },
      {
        name: 'purpose',
        ...
        type: 'text',
        rows: 4,
        initialValue: 'To establish a collaborative partnership to provide rapid, transitional housing scholarships for individuals in recovery from Substance Use Disorder (SUD), ensuring funds are deployed efficiently and beneficiaries are housed in safe, certified environments.',
        readOnly: true,
      },
      {
        name: 'term',
        ...
        type: 'text',
        rows: 2,
        initialValue: 'This MOU shall be in effect for one year from the date of signing and will auto-renew unless terminated by either party with 30 days\' written notice.',
        readOnly: true,
      },
      {
      ...
      },
      {
        ...
        type: 'text',
        rows: 3,
        initialValue: 'Both parties agree to handle all beneficiary data in strict accordance with HIPAA and 42 CFR Part 2. This MOU acts as a BAA-equivalent for the limited data being shared.',
        readOnly: true,
      },
      {
        name: 'fullDocument',
        ...
        initialValue: [
          {
            _type: 'block',
            style: 'h1',
            children: [{ _type: 'span', text: 'Metzler Foundations Preferred Provider Network Memorandum of Understanding' }]
          },
          {
            _type: 'block',
            style: 'h2',
          ...
          },
          {
            _type: 'block',
            style: 'normal',
            children: [{ _type: 'span', text: 'This Memorandum of Understanding (MOU) is made between Metzler Foundations, Inc. ("The Foundation") and [Partner Facility Name] ("The Provider").' }]
          },
          {
            _type: 'block',
            style: 'h2',
          ...
          },
          {
            _type: 'block',
            style: 'normal',
            children: [{ _type: 'span', text: 'To establish a collaborative partnership to provide rapid, transitional housing scholarships for individuals in recovery from Substance Use Disorder (SUD), ensuring funds are deployed efficiently and beneficiaries are housed in safe, certified environments.' }]
          },
          {
            _type: 'block',
            style: 'h2',
          ...
          },
          {
            _type: 'block',
            style: 'normal',
            children: [{ _type: 'span', text: '• Referral & Verification: Perform all beneficiary intake and automated eligibility verification\n• Payment: Direct ACH transfers within 24 hours of approval\n• Data: Share only minimum necessary information for placement' }]
          },
          {
            _type: 'block',
            style: 'h2',
          ...
          },
          {
            _type: 'block',
            style: 'normal',
            children: [{ _type: 'span', text: 'Both parties agree to handle all beneficiary data in strict accordance with HIPAA and 42 CFR Part 2. This MOU acts as a BAA-equivalent for the limited data being shared.' }]
          }
        ],
        readOnly: true,
      },
